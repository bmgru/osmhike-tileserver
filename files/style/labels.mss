...
/* 
================================================================== 
BICYCLE ROUTES LABELS


Bicycle/mtb routes  have their "REF" ( GTV, 13 ...) printed inside a shield ( an icon, with a text inside the icon)
The shield color is the one of the .svg file 
The text color is defined by shield-fill

The difficulty is to have text color visible, compared to the shield color

================================================================== 
*/

// width is computed from number of characters in [ref] , height is always 1
...
#bicycle_routes_labels[type='lcn'][zoom >= 12][width <= 8] {
  ...
  [route='mtb'] {shield-file: url("symbols/shields/mtb_[width]x[height].svg"); }
  shield-transform: "scale(0.75)";
  shield-avoid-edges: true;         // do not draw shield over a tile boundary, because it causes ugly stuff
  shield-fill: white;

}

//Route name label
// some routes have a long name like "Traversee du Jura" , which is printed along the route
