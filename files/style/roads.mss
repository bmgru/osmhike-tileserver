...
// -- Zoom 11 --
// Width of ways
@rdz11_motorway_trunk: 3;
@rdz11_primary: 3;
@rdz11_secondary: 3;
@rdz11_motorway_link: 1.5;
@rdz11_primary_link: 1.5;
@rdz11_secondary_link: 1.5;
@rdz11_tertiary: 0;
...
// -- Zoom 12 --
@rdz12_motorway_trunk: 3;
@rdz12_primary: 3;
@rdz12_secondary: 3;
@rdz12_motorway_link: 2;
@rdz12_primary_link: 1.5;
@rdz12_secondary_link: 1.5;
@rdz12_tertiary: 1;
...
@rdz13_primary_link: 1.5;
@rdz13_secondary_link: 1.5;
@rdz13_tertiary: 2;
...
#roads_high::outline[zoom>=11],#tunnel::outline[zoom>=11],#bridge::outline[zoom>=11] {
  [type='motorway'] {
    line-cap: round;
    line-join: round;
    #tunnel::outline,
...
#roads_high::outline[zoom>=12],#tunnel::outline[zoom>=12],#bridge::outline[zoom>=12] {
  [type='tertiary'] {
    line-cap: round;
    line-join: round;
    #tunnel::outline,
...
#roads_high::outline[zoom>=13],#tunnel::outline[zoom>=13],#bridge::outline[zoom>=13] {
  [type='residential'] {
    line-cap: round;
    line-join: round;
    #tunnel::outline,
...
// roads base color
//===========================================================================
#roads_high::inline[zoom>=11],#tunnel::inline[zoom>=11],#bridge::inline[zoom>=11] {
...
#roads_high::inline[zoom>=11],#tunnel::inline[zoom>=11],#bridge::inline[zoom>=11] {
  [type='track'],[type='bridleway'],[type='footway']{

    // different type of dash, deoending on surface . If can_bicycle=no then small points
    [zoom >= 13] {
    ...
    // specific color for track/bridleway/footway
    [type='track'] {
    ...
    [type='footway'] {
        ...
        #tunnel { line-color: lighten(@footway-fill, 10%); }
    }
...
// if path compatible bike ( 'alpine'='' and can_bicycle != no ) take color mixed-cycle-fill , and make difference between road/cyclocross/mtb+unknown
// otherwise take color path-fill and make difference alpine='' / alpine='medium'/alpine='high'
#roads_high::inline[zoom>=11],#tunnel::inline[zoom>=11],#bridge::inline[zoom>=11] {
  [type='path'][zoom >= 14]
  {
    ...
    [alpine='medium'] { line-dasharray: 8,4; }
    [alpine='high'] { line-dasharray: 2,4; }

    // easy and not bike incompatible => blue color
    [alpine=''][can_bicycle != 'no']{
        line-color: @mixed-cycle-fill;
        [surface_type='cyclocross']                         { line-dasharray: 10,1; }  // some path in mountain have smoothness=intermediate, which makes surface=road 
